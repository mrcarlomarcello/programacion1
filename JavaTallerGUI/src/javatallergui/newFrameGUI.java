 ...
 */
package javatallergui;

/**
 *
 * @author marcellomenjivarmontesdeoca
 */
public class newFrameGUI extends javax.swing.JFrame {

    /**
     * Creates new form newFrameGUI
     */
    public newFrameGUI() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newFrameGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new newFrameGUI().setVisible(true);
            }
        });
    }
